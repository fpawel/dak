...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "ДАК-М"
...
InstallDir "$PROGRAMFILES\Настройка ДАК-М в цехе 1"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\ДАК-М.lnk" "$INSTDIR\dak.exe"
  CreateShortCut "$DESKTOP\ДАК-М.lnk" "$INSTDIR\dak.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\ДАК-М.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\ДАК-М.lnk"
