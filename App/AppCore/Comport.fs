...
module Ports =
    ...
    let getPort (config : Config.Comport.Config) = 
    ...
    let removeFailedPort (config : Config.Comport.Config) = 
...
module private Helpers2 =     
    ...
    let applyPort (sets : Config.Comport.Config) = 
...
let write (sets : Config.Comport.Config) (txd:byte seq)  =
